...
extension UIFont {
    ...
    static let _18CircularStdBook = UIFont(name: "CircularStd-Book", size: 18)!
    ...
    static let _18CircularStdMedium = UIFont(name: "CircularStd-Medium", size: 18)!
    ...
    static let _16CircularStdBold = UIFont(name: "CircularStd-Bold", size: 16)!
    static let _18CircularStdBold = UIFont(name: "CircularStd-Bold", size: 18)!
